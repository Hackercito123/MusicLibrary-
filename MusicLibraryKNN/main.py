...
def main():
  ...
  # Demonstrate fitting most songs into a given time
  playlist_time = 1 # Example: 22 minutes
  print(f"\nFitting most songs into {playlist_time} minutes playlist:")
  library.fit_most_songs(playlist_time)

  # Demonstrate fitting most songs into a given time
  playlist_time = 1000 # Example: 22 minutes
  print(f"\nFitting most songs into {playlist_time} minutes playlist:")
  library.fit_most_songs(playlist_time)

  # Demonstrate fitting most songs into a given time
  playlist_time = 2.2 # Example: 22 minutes
  print(f"\nFitting most songs into {playlist_time} minutes playlist:")
  library.fit_most_songs(playlist_time)
  ...
  new_library_2.add_song(Song("WHATS POOPIN", "Jack Harlow", duration= 141))
